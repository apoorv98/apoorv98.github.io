...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<github-pages-health-check>.freeze, ["= 1.0.1"])
    s.add_runtime_dependency(%q<jekyll-coffeescript>.freeze, ["= 1.0.1"])
    s.add_runtime_dependency(%q<jekyll-seo-tag>.freeze, ["= 1.3.1"])
    ...
    s.add_dependency(%q<github-pages-health-check>.freeze, ["= 1.0.1"])
    s.add_dependency(%q<jekyll-coffeescript>.freeze, ["= 1.0.1"])
    s.add_dependency(%q<jekyll-seo-tag>.freeze, ["= 1.3.1"])
